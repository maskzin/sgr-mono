...
public class ArticleResource {
     ...
     */
    @GetMapping("/articles")
    public List<Article> getAllArticles(@RequestParam(required = false) String filter) {
        if ("affectation-is-null".equals(filter)) {
            log.debug("REST request to get all Articles where affectation is null");
            return articleService.findAllWhereAffectationIsNull();
        }
